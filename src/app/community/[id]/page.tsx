    ...
    <section className="bg-white dark:bg-gray-900">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          ...
          <div className="mr-auto px-4 w-full lg:ml-10 lg:col-span-5">
            ...
            <p className='flex justify-end'>Created by - Username</p>
            <div className='my-6'>
            ...
            <Modal showModal={showModal} setShowModal={setShowModal} confirmMessage={"Are you sure you want to join the community?"}/>
