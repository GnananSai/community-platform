                    ...
                    <div className="col-span-4 sm:col-span-3">
                        <div className="bg-white shadow rounded-lg p-6">
                            ...
                            <div className=' flex justify-center items-center'>
                                <button className='bg-blue-gray-800 text-white hover:border hover:border-blue-gray-800 hover:bg-white hover:text-blue-gray-800 p-4 rounded-lg transition ease-in-out hover:scale-105'>Edit Profile</button>
                            </div>
                        </div>
                    </div>
