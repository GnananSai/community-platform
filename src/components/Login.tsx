...
const Login = () => {
  return (
      <div className='h-screen w-screen flex justify-center items-center bg-gray-800'>
        <div className='sm:shadow-xl p-8 bg-white rounded-xl'>
            ...
            <form action="#">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" className='mb-5 p-2 bg-gray-50 border border-gray-300 text-gray-900 sm:text-md rounded-lg' placeholder="name@email.com" required={true}/>
                </div>

                <div>
                    <label htmlFor="password" className='block mb-2 text-sm font-medium text-gray-800'>Your password:</label>
                    <input type="password" name="password" id="password" className='mb-5 p-2 bg-gray-50 border border-gray-300 text-gray-900 sm:text-md rounded-lg' placeholder="••••••••" required={true}/>
                </div>
                ...
                <a href="#" className="mb-5 text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Forgot password?</a>
