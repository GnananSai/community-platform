...
interface CommunityHeroProps {
  scrollToCommunityCreate: (event: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => void;
}

const CommunityHero: React.FC<CommunityHeroProps> = ({ scrollToCommunityCreate }) => {
  return (
    <div>
